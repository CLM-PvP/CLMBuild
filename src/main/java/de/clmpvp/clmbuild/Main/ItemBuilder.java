...
public class ItemBuilder {
    ...
    public static ItemStack createItem(Material material, String s, Integer amount, String[] lore) {
    ...
    public static Inventory InvF(Inventory inv, ItemStack item, Integer Reihen) {
